...
import MenuViewSaneadora from "./MenuSaneadora.js";
var LoadMatriculas = /** @class */ (function (_super) {
    __extends(LoadMatriculas, _super);
    function LoadMatriculas(buttonView, modal, buttonClose, url, contentLoad, buttonCloseAlert, buttonAcceptAlert) {
        var _this = _super.call(this, buttonView, modal, buttonClose, url, contentLoad) || this;
        _this.contentMatriculas = null;
        _this.clickOutside = null;
        _this.buttonCloseAlert = document.querySelector(buttonCloseAlert);
        _this.buttonAcceptAlert = document.querySelector(buttonAcceptAlert);
        return _this;
    }
    LoadMatriculas.prototype.deleteMatricula = function (id) {
        try {
        }
        catch (error) {
            console.log(error);
    ...
    LoadMatriculas.prototype.cancelNotification = function () {
        var _a, _b, _c, _d;
    ...
    LoadMatriculas.prototype.notificationDelete = function (id) {
        var _this = this;
        var _a, _b, _c, _d;
    ...
    LoadMatriculas.prototype.addEventDelete = function () {
        var _this = this;
        var _a;
        (_a = this.contentMatriculas) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function (event) {
            event.stopPropagation();
            var currentTarget = event.currentTarget;
            if (currentTarget.dataset.buttonIcon === "delete") {
                if (currentTarget.dataset.id)
                    _this.notificationDelete(currentTarget.dataset.id);
            }
        });
    };
