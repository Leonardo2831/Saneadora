...
var ViewSaneadora = /** @class */ (function (_super) {
    __extends(ViewSaneadora, _super);
    function ViewSaneadora(buttonView, modal, buttonClose, url, contentLoad, notificationSaveSaneadora, modalAlert, buttonCloseAlert, buttonAcceptAlert, 
    // Selectors for LoadSaneadora
    tableInfosCadastro, tableInfosOnus, tableInfosNumbers, tableInfosEstremacao, contentFinalText, buttonSave) {
        var _this = _super.call(this, buttonView, modal, buttonClose, url, contentLoad, notificationSaveSaneadora, modalAlert, buttonCloseAlert, buttonAcceptAlert) || this;
        _this.loadSaneadora = new LoadSaneadora(url, tableInfosCadastro, tableInfosOnus, tableInfosNumbers, tableInfosEstremacao, contentFinalText, notificationSaveSaneadora, buttonSave);
        return _this;
    }
    ViewSaneadora.prototype.addMatriculas = function (data) {
        var _this = this;
        var _a, _b, _c;
        if (!data)
            return;
    ...
    ViewSaneadora.prototype.openModal = function () {
    ...
    ViewSaneadora.prototype.createMatricula = function (matricula) {
    ...
    ViewSaneadora.prototype.fetchMatriculas = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return ViewSaneadora;
}(DeleteSaneadora));
export default ViewSaneadora;
