...
var SaveSaneadora = /** @class */ (function () {
    ...
    SaveSaneadora.prototype.save = function () {
        return __awaiter(this, void 0, void 0, function () {
            var matricula, idAttribute, saneadoraObject, method, urlReq, response, notification, error_1;
            var _this = this;
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        this.tableInfosNumbers = document.querySelector(this.selectorNumbers);
                        this.tableInfosEstremacao = document.querySelector(this.selectorEstremacao);
                        matricula = (_a = this.tableInfosCadastro) === null || _a === void 0 ? void 0 : _a.querySelector("[data-matricula]");
                        ...
                        idAttribute = (_b = this.buttonSave) === null || _b === void 0 ? void 0 : _b.getAttribute("data-id");
                        saneadoraObject = {
                            id: idAttribute ? idAttribute : new Date().getTime().toString(),
                            // criar modal para escrever nome
                            nome: "Matricula " + (matricula === null || matricula === void 0 ? void 0 : matricula.textContent),
                            tableCadastro: (_c = this.tableInfosCadastro) === null || _c === void 0 ? void 0 : _c.innerHTML,
                            tableOnus: (_d = this.tableInfosOnus) === null || _d === void 0 ? void 0 : _d.innerHTML,
                            tableNumbers: (_e = this.tableInfosNumbers) === null || _e === void 0 ? void 0 : _e.innerHTML,
                            tableEstremacao: (_f = this.tableInfosEstremacao) === null || _f === void 0 ? void 0 : _f.innerHTML,
                            textSaneadora: ((_g = this.contentFinalText) === null || _g === void 0 ? void 0 : _g.innerHTML) || "",
                        };
                    ...
                    case 2:
                        ...
                        notification = (_h = this.buttonSave) === null || _h === void 0 ? void 0 : _h.querySelector(this.notificationSelector);
                        if (notification)
